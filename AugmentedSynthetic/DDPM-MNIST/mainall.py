...
lrate = 3e-5
save_model = True
save_dir = './data/t500n60k/'
save_dir2 = './data/t500n60k/'
...
for w in Wall:
    ...
    for generation in range(1,generation_number):
        ...
        #### Loading dataset
        dataloader = util.load_datasets(generation,save_dir, w, batch_size, N_with_w)
        ## Creating model
        ...
        torch.save( C_with_w.cpu(),save_dir2+ f"gen_index_with_w{generation}_w{w}" )
