#!/usr/bin/env python3
"""
Single-class Jacobian analysis for Paper-Style Augmented Synthetic GAN-MNIST.
...
def main():
    ...
    print(f"\nPaper-Style Augmented Synthetic GAN-MNIST Single-Class Jacobian Analysis")
...
def plot_results(results_dict, stats, save_dir):
    ...
    plt.suptitle(f'Paper-Style Augmented Synthetic GAN-MNIST - Class {CLASS_LABEL} ({CLASS_NAME})', fontsize=14)
    plt.tight_layout()
