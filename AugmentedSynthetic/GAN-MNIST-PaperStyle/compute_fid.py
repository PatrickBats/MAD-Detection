#!/usr/bin/env python3
"""
Compute FID scores for Paper-Style Augmented Synthetic GAN-MNIST across generations.
...
def main():
    ...
    # Summary
    print("\n" + "="*50)
    print("FID Scores Summary (Paper-Style Augmented Synthetic Loop)")
    print("="*50)
    ...
    plt.title('Paper-Style Augmented Synthetic GAN-MNIST - FID Across Generations', fontsize=14)
