...
class Discriminator(nn.Module):
    """Conditional Discriminator for KMNIST"""
    def __init__(self):
...
def load_dataset(generation, save_dir, batch_size):
    ...
    if generation == 0:
        ...
        dataset = KMNIST("../data", train=True, download=True, transform=tf)
...
if __name__ == "__main__":
    print(f"Starting KMNIST MADness experiment with {generation_number} generations")
    ...
    print(f"\n{'='*50}")
    print("KMNIST MADness experiment complete!")
    print(f"{'='*50}")
